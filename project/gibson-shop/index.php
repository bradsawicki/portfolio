...
<?php include $_SERVER['DOCUMENT_ROOT'].'/views/header.php'; ?>
	...
	<section class="main">
		<div class="wrapper cf">
			...
			<h1 class="title">The Gibson Shop</h1>
			<p class="role">Branding, UI / UX, Responsive Web Design, Drupal Development</p>
			<div class="pic"><img src="/images/pic-desktop-gibson-shop.jpg" alt="The Gibson Shop" /></div>
			<div class="content">
			...
			<div class="project-nav">
			    ...
			    <a href="http://thegibsonshop.com" target="_blank" class="visit">Visit Site <i class="icon"></i></a>
