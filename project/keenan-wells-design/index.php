<?php $title_tag = "Keenan Wells Design"; ?>
...
<?php include $_SERVER['DOCUMENT_ROOT'].'/views/header.php'; ?>
	...
	<section class="main">
		<div class="wrapper cf">
			...
			<h1 class="title">Keenan Wells Design</h1>
			...
			<div class="project-nav">
			    ...
			    <a href="http://keenanwells.com" target="_blank" class="visit">Visit Site <i class="icon"></i></a>
